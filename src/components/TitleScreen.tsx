...
export const TitleScreen: React.FC<TitleScreenProps> = ({ onStart, onOpenStore }) => {
  ...
  return (
    <div className="relative flex-1 flex flex-col items-center justify-center p-2 sm:p-4 text-center select-none overflow-y-auto overflow-x-hidden min-h-0 bg-slate-950 text-slate-100 font-sans">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto flex flex-col items-center justify-center shrink-0 py-2 sm:py-6 space-y-3 sm:space-y-6 my-auto">
        ...
        >
          ...
          <div className="relative">
            ...
            <h1 className="absolute top-[1.5px] left-[1.5px] font-['Press_Start_2P'] text-xl sm:text-3xl md:text-5xl text-pink-500/50 py-0.5 sm:py-1 text-center leading-tight blur-[1px]">
              KOMBAT<br/>KUCING
            </h1>
            <h1 className="absolute -top-[1.5px] -left-[1.5px] font-['Press_Start_2P'] text-xl sm:text-3xl md:text-5xl text-cyan-500/50 py-0.5 sm:py-1 text-center leading-tight blur-[1px]">
              KOMBAT<br/>KUCING
            </h1>
            
            <h1 className="relative font-['Press_Start_2P'] text-xl sm:text-3xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-b from-white via-cyan-100 to-cyan-500 drop-shadow-[0_0_16px_rgba(34,211,238,0.8)] py-0.5 sm:py-1 text-center leading-tight">
              KOMBAT<br/>KUCING
            </h1>
          </div>
          
          <div className="mt-1 sm:mt-2 flex items-center space-x-3 sm:space-x-4">
            <div className="w-6 sm:w-12 h-px bg-gradient-to-r from-transparent to-pink-500" />
            <div className="font-['Silkscreen'] text-[10px] sm:text-sm md:text-base text-pink-400 tracking-[0.3em] sm:tracking-[0.6em] uppercase font-bold drop-shadow-[0_0_12px_rgba(236,72,153,0.8)]">
              CYBER CITY
            </div>
        ...
        <motion.div
          ...
          className="relative flex justify-center items-end h-22 sm:h-36 w-full max-w-xs sm:max-w-md mt-1 sm:mt-4"
        >
          {/* Ground Platform */}
          <div className="absolute bottom-0 inset-x-6 sm:inset-x-12 h-5 sm:h-8 bg-slate-900 border-t border-cyan-500/50 shadow-[0_-10px_30px_rgba(6,182,212,0.15)] rounded-[100%] [transform:perspective(200px)_rotateX(60deg)]" />
          ...
          <div className="relative flex items-end justify-between w-full px-6 sm:px-12 z-10">
            ...
            >
              <div className="scale-[0.8] sm:scale-[1.15] origin-bottom">
                <PixelSprite character={oyen} action="idle" />
              </div>
              <div className="absolute -bottom-5 text-[6.5px] sm:text-[8px] font-mono text-cyan-400 bg-cyan-950/80 px-1.5 py-0.2 rounded border border-cyan-800">P1_RDY</div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="font-['Press_Start_2P'] text-xs sm:text-base text-yellow-400 drop-shadow-[0_0_12px_rgba(250,204,21,0.6)] z-20 mb-4 sm:mb-6"
            >
              VS
            </motion.div>
            ...
            <motion.div 
              ...
              className="relative flex flex-col items-center"
            >
              <div className="scale-[0.8] sm:scale-[1.15] origin-bottom [transform:scaleX(-1)]">
                <PixelSprite character={mechaDog} action="idle" />
              </div>
              <div className="absolute -bottom-5 text-[6.5px] sm:text-[8px] font-mono text-pink-400 bg-pink-950/80 px-1.5 py-0.2 rounded border border-pink-800">CPU_ACT</div>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="flex flex-col w-full max-w-xs sm:max-w-sm space-y-2 sm:space-y-3 px-2 sm:px-4 z-20 mt-2 sm:mt-4"
        >
          {/* Start Game Button (Primary) */}
          <button
            id="btn-start-game"
            onClick={handleStart}
            className="group relative w-full h-12 sm:h-15 bg-slate-900 border border-cyan-500 rounded-none overflow-hidden cursor-pointer active:scale-95 transition-transform"
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center space-x-2 sm:space-x-3 z-20">
              <Play className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400 group-hover:text-slate-950 transition-colors" fill="currentColor" />
              <span className="font-['Press_Start_2P'] text-xs sm:text-sm text-cyan-300 group-hover:text-slate-950 transition-colors tracking-widest drop-shadow-sm">
                INITIALIZE
              </span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            ...
            <button
              id="btn-cyber-store"
              onClick={handleStore}
              className="relative group w-full py-2 sm:py-3 bg-slate-900/60 hover:bg-amber-950/60 text-amber-400 border border-slate-700 hover:border-amber-500 transition-colors flex items-center justify-center space-x-1.5 cursor-pointer rounded-none"
            >
              <ShoppingBag className="w-3.5 h-3.5 group-hover:scale-110 transition-transform" />
              <span className="font-mono text-[10px] sm:text-xs font-bold tracking-wide">STORE</span>
              {/* Corner accent */}
              <div className="absolute top-0 left-0 w-1.5 h-1.5 bg-amber-500/0 group-hover:bg-amber-500 transition-colors" />
            </button>

            {/* Coins Display Panel */}
            <div className="relative w-full py-2 sm:py-3 bg-slate-900/80 text-slate-300 border border-slate-700 flex items-center justify-between px-3 overflow-hidden">
              <div className="absolute top-0 right-0 w-6 h-6 bg-slate-800 rotate-45 translate-x-3 -translate-y-3" />
              <div className="flex flex-col z-10">
                <span className="text-[7px] sm:text-[8px] text-slate-500 font-mono">WALLET</span>
                <div className="flex items-center space-x-1 text-yellow-400">
                  <Coins className="w-3 h-3" />
                  <span className="font-mono font-bold text-xs sm:text-sm tracking-wide">{coins}</span>
                </div>
              </div>
            </div>
          </div>
